...
<div class="container">
    ...
    <div class="eval-main">
        <form method="POST" action="{{ route('ANSEvalUpdate', ['id' => $user->id]) }}">
            @csrf
            <header class="eval-hdr">
                You’re now in <span style="color: #2F96D0;">ANS Evaluation</span>
            </header>
                ...
                <div class="proposed-structure-data">
                    ...
                    <div class="data-field">
                        <div class="data-left">
                            ...
                            <div class="data-value">
                                <input name="proposed_height" type="text" value="{{$applicationData->proposed_height}}" style="width: 50%;" readonly>
                            </div>
                            @endunless
                            ...
                            <div class="data-value">
                                <input name="type_of_hcp" type="text" placeholder="Enter data" style="width: 50%;" readonly>
                            </div>
                            @endunless
                        </div>
                        <div class="data-right">
                            ...
                            <div class="data-value">
                                <input type="text" value="{{$applicationData->height_of_existing_structure}}" style="width: 50%;" readonly>
                            </div>
                            @endunless
                            <div class="data-label">Longitude (E)</div>
                            <div class="data-value">
                                <input type="text" name="longitude_deg" value="{{$applicationData->long_deg}}" style="width: 15%;" readonly>
                                <input type="text" name="longitude_min" value="{{$applicationData->long_min}}" style="width: 15%;" readonly>
                                <input type="text" name="longitude_sec" value="{{$applicationData->long_sec}}" style="width: 15%;" readonly>
                            </div>

                            <div class="data-label">Orthometric Height</div>
                            <div class="data-value">
                                <input name="orthometric_height" type="text" value="{{$applicationData->orthometric_height}}" style="width: 40%;" readonly>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div>
                ...
                <div class="data-field">
                    <div class="data-left">
                        ...
                        <div class="data-value">
                            <div class="data-value">
                                <input class="airport" type="text" value="{{$aerodrome->reference_aerodrome}}" readonly>

                            </div>
                        </div>
                        <div class="data-label">Maximum Allowed Top Elevation</div>
                        <div class="data-value">
                            <input type="text" name="max_allowed_top_elev" value="{{$aerodrome->max_allowed_top_elev}}" placeholder="Enter data" readonly>
                        </div>
                        <div class="data-label">Remarks</div>
                        <div class="data-value">
                            <input type="text" name="height_eval_remarks" value="{{$aerodrome->height_eval_remarks}}" placeholder="Enter data" readonly>
                        </div>
                    </div>
                    <div class="data-right">
                        <div class="data-label">Proposed Top Elevation</div>
                        <div class="data-value">
                            <input type="text" name="proposed_top_elev" value="{{$aerodrome->proposed_top_elev}}" placeholder="Enter data" readonly>
                        </div>
                        ...
                        <div class="data-value">
                            <div class="dropdown">
                                <select name="supervisor_result" id="supervisor_result" class="form-control form-control-lg">
                                    <option value="">Select a Type</option>
                                    <option class="eval bg-success" value="Approved" {{ $aerodrome->supervisor_result== 'Approved' ? 'selected' : '' }}>Approved</option>
                                    <option class="eval bg-danger" value="Denied" {{ $aerodrome->supervisor_result == 'Denied' ? 'selected' : '' }}>Denied</option>
                                </select>
                            </div>

                            <label for="retain_supervisor_result">Retain</label>
                            <input type="checkbox" id="retain_supervisor_result" name="retain_supervisor_result" value="1">
                        </div>
                    </div>
