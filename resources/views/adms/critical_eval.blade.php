        ...
        <form method="POST" action="{{ route('updateCriticalEvaluation', ['id' => $user->id]) }}">
            ...
            <div class="data">
                ...
                <div>
                    ...
                    <div class="data-field">
                        <div class="data-left">
                            ...
                            <div class="data-value">
                                <input name="site_loc" type="text" value="{{$applicationData->site_address}}">
                                <a class="edit-link" href="">Edit</a>
                                <label for="retain_site_loc">Retain</label>
                                <input type="checkbox" id="retain_site_loc" name="retain_site_loc" value="1">
                            </div>
                ...
                <section class="warning">
                    <p class="warning-msg">Please double-check the information to avoid any input error and re-submission. Thank you.</p>
                </section>

                <div class="crit-area-container">
