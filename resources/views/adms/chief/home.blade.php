...
<div class="container">
    <header class="supervisor-header">For Approval</header>
        ...
        <table class="table">
            ...
            <tbody>
                <tr>
                    ...
                    <td>For review by Department Chief</td>
                    <td>
                        <a href="{{ route('ADMSChiefView',['id' => $queuedata->id]) }}" class="btn btn-primary">Evaluate</a>
                    </td>
                </tr>
            </tbody>
            @endforeach
