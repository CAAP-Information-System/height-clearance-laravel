            ...
            <div>
                ...
                <div class="data-field">
                    ...
                    <div class="data-right">
                        ...
                        <div class="data-value">
                            <div class="dropdown">
                                <select name="eval_result" id="type_of_structure" class="form-control form-control-lg">
                                    <option value="">Select a Type</option>
                                    <option class="eval bg-success" value="Approved" {{ old('eval_result_choice') == 'Approved' ? 'selected' : '' }}>Approved</option>
                                    <option class="eval bg-danger" value="Denied" {{ old('eval_result_choice') == 'Denied' ? 'selected' : '' }}>Denied</option>
                                </select>
                            </div>
                        </div>
                    </div>
