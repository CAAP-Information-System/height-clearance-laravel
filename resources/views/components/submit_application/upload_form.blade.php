...
<div class="container">
    ...
    @if ($owner->permit_type == 'HCP' && $owner->building_type == 'Temporary')
    ...
    @elseif ($owner->permit_type == 'HCP' && $owner->building_type == 'Permanent')
    <form action="{{ route('submitApplication') }}" method="post" enctype="multipart/form-data">
        @csrf
        <div class="container py-5 h-100">
            <section class="elevation-plan">
    ...
    @else
    <div>
        <h1>FORM TYPE DOES NOT EXIST</h1>
    </div>
    @endif
